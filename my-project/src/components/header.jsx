    ...
    <header className='h-screen'>
      <nav className='h-16 flex'>
        <section className='h-full flex justify-between container m-auto'>
          <LazyLoad className='w-1/12 p-1' offset={100} once>
      ...
      <section className='h-full container m-auto py-8 flex flex-col justify-start'>
        <div className='h-1/2 flex justify-between items-start'>
          ...
          <LazyLoad
            className='w-1/2 h-3/4 py-8 flex justify-center items-center'
            offset={100}
            once
          >
            <img className='h-full' src={logo} alt={logo} />
